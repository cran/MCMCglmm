...
This tutorial is now a bit out of date and I would recommend reading the course notes (\texttt{vignette("CourseNotes", "MCMCglmm")}) for more indepth and up to date information. 
