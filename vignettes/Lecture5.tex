...
-0.87228 -0.19172  0.00431  0.17942  1.09905 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)  1.08947    0.03724  29.252   <2e-16 ***
y.hol       -0.07165    0.03493  -2.051   0.0406 *  
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1

Residual standard error: 0.2875 on 798 degrees of freedom
Multiple R-squared:  0.005243,	Adjusted R-squared:  0.003997 
F-statistic: 4.206 on 1 and 798 DF,  p-value: 0.0406
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
     ...
     -0.167295       0.037855       0.001197       0.001129 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
-0.24373 -0.19186 -0.16717 -0.14186 -0.09325 
\end{Soutput}
\end{Schunk}
...
{\color{red} \texttt{1}}&\texttt{1.300508}&\texttt{0.615082}&\texttt{1}\\
{\color{red} \texttt{2}}&\texttt{0.749864}&\texttt{0.921095}&\texttt{1}\\
\vdots&\vdots&\vdots\\
{\color{red} \texttt{800}}&\texttt{1.187419}&\texttt{1.355836}&\texttt{200}\\
\end{array}&
\Longrightarrow
\begin{array}{ccccc}
&\texttt{y}&{\color{blue} \texttt{trait}}&\texttt{id}&{\color{red} \texttt{units}}\\
1&\texttt{1.300508}&{\color{blue} \texttt{y.hol}}&\texttt{1}&{\color{red} \texttt{1}}\\
2&\texttt{0.749864}&{\color{blue} \texttt{y.hol}}&\texttt{1}&{\color{red} \texttt{2}}\\
\vdots&\vdots&\vdots&\vdots\\
800&\texttt{1.187419}&{\color{blue} \texttt{y.hol}}&\texttt{200}&{\color{red} \texttt{800}}\\
801&\texttt{0.615082}&{\color{blue} \texttt{y.car}}&\texttt{1}&{\color{red} \texttt{1}}\\
802&\texttt{0.921095}&{\color{blue} \texttt{y.car}}&\texttt{1}&{\color{red} \texttt{2}}\\
\vdots&\vdots&\vdots&\vdots\\
1600&\texttt{1.355836}&{\color{blue} \texttt{y.car}}&\texttt{200}&{\color{red} \texttt{800}}\\
\end{array}
\end{array}
\end{displaymath}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
        ...
        Mean      SD  Naive SE Time-series SE
[1,] 0.65235 0.02021 0.0006391       0.001937
[2,] 0.09908 0.01173 0.0003709       0.001699
[3,] 0.24856 0.01879 0.0005943       0.001966

2. Quantiles for each variable:

        2.5%     25%     50%    75%  97.5%
var1 0.61431 0.63734 0.65249 0.6664 0.6905
var2 0.07912 0.09073 0.09837 0.1056 0.1264
var3 0.21299 0.23580 0.24859 0.2623 0.2841
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
       ...
       Mean      SD  Naive SE Time-series SE
[1,] 0.3463 0.03030 0.0009582       0.002842
[2,] 0.2651 0.02920 0.0009233       0.002732
[3,] 0.3886 0.03178 0.0010050       0.004191

2. Quantiles for each variable:

       2.5%    25%    50%    75%  97.5%
var1 0.2881 0.3253 0.3460 0.3671 0.4045
var2 0.2103 0.2458 0.2639 0.2838 0.3245
var3 0.3276 0.3655 0.3904 0.4119 0.4483
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
         ...
         Mean       SD  Naive SE Time-series SE
[1,] 0.829784 0.018383 0.0005813      0.0022101
[2,] 0.007437 0.002568 0.0000812      0.0006723
[3,] 0.162779 0.017491 0.0005531      0.0020628

2. Quantiles for each variable:

         2.5%      25%      50%      75%   97.5%
var1 0.793822 0.817025 0.830739 0.843111 0.86483
var2 0.002951 0.005512 0.007192 0.009112 0.01307
var3 0.130193 0.150187 0.162079 0.175204 0.19718
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
         0%         25%         50%         75%        100% 
0.001472446 0.004033974 0.006591208 0.008490988 0.017107407 
\end{Soutput}
\end{Schunk}
...
trait:units    0.3667   0.2725    0.484    40.44

 Location effects: art ~ trait * (fem + mar + kid5 + phd + ment) 

                        post.mean   l-95% CI   u-95% CI
(Intercept)             0.3182569 -0.0622403  0.6304546
traitza_art            -0.4843942 -1.0036732  0.0009257
femWomen               -0.1885760 -0.3842008 -0.0268506
marMarried              0.0915397 -0.0916301  0.2740610
kid5                   -0.1304865 -0.2623142 -0.0010553
phd                     0.0167708 -0.0647252  0.1055120
ment                    0.0198223  0.0131391  0.0270956
traitza_art:femWomen    0.0077132 -0.2655308  0.2834576
traitza_art:marMarried  0.1403985 -0.2083140  0.4545889
traitza_art:kid5       -0.0759386 -0.2701742  0.1326449
traitza_art:phd         0.0048863 -0.1459509  0.1231912
traitza_art:ment        0.0268186  0.0130392  0.0418162
                       eff.samp  pMCMC    
(Intercept)               229.1  0.080 .  
traitza_art               237.1  0.060 .  
femWomen                  418.3  0.034 *  
marMarried                307.5  0.378    
kid5                      217.7  0.050 *  
phd                       216.8  0.686    
ment                      552.5 <0.001 ***
traitza_art:femWomen      229.8  0.942    
traitza_art:marMarried    198.8  0.386    
traitza_art:kid5          195.7  0.478    
traitza_art:phd           220.9  0.918    
traitza_art:ment          136.2 <0.001 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
\end{Soutput}
\end{Schunk}
