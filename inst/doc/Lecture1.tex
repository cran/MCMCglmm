...
\end{Sinput}
\begin{Soutput}
[1]  0.01464054  0.87328871 -1.02794620  0.68566463  0.44943698
\end{Soutput}
\end{Schunk}
...
(Dispersion parameter for gaussian family taken to be 0.573403)
...
+         log(dinvgamma(par[2], shape = priorR$nu/2, scale = (priorR$nu * 
+             priorR$V)/2))
+ }
\end{Sinput}
\end{Schunk}
