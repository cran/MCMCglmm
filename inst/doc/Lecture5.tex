...
A simple regression suggests the two types of spending are negatively related but the association is weak with the $R^{2}=$ 0.01.
...
-0.812283 -0.185706  0.003196  0.199748  1.044004 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)  1.09700    0.03755   29.21  < 2e-16 ***
y.hol       -0.10109    0.03650   -2.77  0.00574 ** 
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

Residual standard error: 0.2893 on 798 degrees of freedom
Multiple R-squared: 0.009521,	Adjusted R-squared: 0.00828 
F-statistic: 7.671 on 1 and 798 DF,  p-value: 0.005743 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
     ...
     -0.164937       0.037675       0.001191       0.001107 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
-0.24070 -0.19029 -0.16448 -0.13987 -0.08853 
\end{Soutput}
\end{Schunk}
...
{\color{red} \texttt{1}}&\texttt{1.341595}&\texttt{1.294920}&\texttt{1}\\
{\color{red} \texttt{2}}&\texttt{1.168534}&\texttt{1.340285}&\texttt{1}\\
\vdots&\vdots&\vdots\\
{\color{red} \texttt{800}}&\texttt{0.892193}&\texttt{1.249724}&\texttt{200}\\
\end{array}&
\Longrightarrow
\begin{array}{ccccc}
&\texttt{y}&{\color{blue} \texttt{trait}}&\texttt{id}&{\color{red} \texttt{units}}\\
1&\texttt{1.341595}&{\color{blue} \texttt{y.hol}}&\texttt{1}&{\color{red} \texttt{1}}\\
2&\texttt{1.168534}&{\color{blue} \texttt{y.hol}}&\texttt{1}&{\color{red} \texttt{2}}\\
\vdots&\vdots&\vdots&\vdots\\
800&\texttt{0.892193}&{\color{blue} \texttt{y.hol}}&\texttt{200}&{\color{red} \texttt{800}}\\
801&\texttt{1.294920}&{\color{blue} \texttt{y.car}}&\texttt{1}&{\color{red} \texttt{1}}\\
802&\texttt{1.340285}&{\color{blue} \texttt{y.car}}&\texttt{1}&{\color{red} \texttt{2}}\\
\vdots&\vdots&\vdots&\vdots\\
1600&\texttt{1.249724}&{\color{blue} \texttt{y.car}}&\texttt{200}&{\color{red} \texttt{800}}\\
\end{array}
\end{array}
\end{displaymath}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
        ...
        Mean      SD  Naive SE Time-series SE
[1,] 0.65610 0.01890 0.0005976       0.002112
[2,] 0.09878 0.01089 0.0003444       0.001363
[3,] 0.24512 0.01783 0.0005637       0.002091

2. Quantiles for each variable:

        2.5%     25%     50%    75%  97.5%
var1 0.62015 0.64287 0.65617 0.6687 0.6941
var2 0.07981 0.09137 0.09816 0.1061 0.1216
var3 0.21072 0.23324 0.24519 0.2573 0.2788
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
       ...
       Mean      SD  Naive SE Time-series SE
[1,] 0.3459 0.02698 0.0008530       0.002639
[2,] 0.2645 0.02826 0.0008936       0.002818
[3,] 0.3896 0.03032 0.0009589       0.003475

2. Quantiles for each variable:

       2.5%    25%    50%    75%  97.5%
var1 0.2955 0.3277 0.3457 0.3645 0.3983
var2 0.2117 0.2449 0.2638 0.2827 0.3193
var3 0.3364 0.3682 0.3893 0.4106 0.4481
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
         ...
         Mean       SD  Naive SE Time-series SE
[1,] 0.828606 0.016713 0.0005285      0.0020787
[2,] 0.007254 0.002621 0.0000829      0.0003470
[3,] 0.164140 0.016198 0.0005122      0.0020002

2. Quantiles for each variable:

         2.5%      25%      50%      75%   97.5%
var1 0.794110 0.817853 0.829137 0.840546 0.85903
var2 0.003942 0.005168 0.006488 0.008977 0.01372
var3 0.134479 0.152669 0.163500 0.174600 0.19792
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
          0%          25%          50%          75%         100% 
0.0005635939 0.0064080572 0.0146266288 0.0194580531 0.0432303842 
\end{Soutput}
\end{Schunk}
...
trait:units    0.3453   0.2482   0.4272    63.32

 Location effects: art ~ trait + trait:(fem + mar + kid5 + phd + ment) 

                        post.mean   l-95% CI   u-95% CI eff.samp  pMCMC    
(Intercept)             0.3432721  0.0425365  0.6911919   221.17  0.044 *  
traitza_art            -0.5677632 -1.1046026  0.0009134   162.49  0.040 *  
traitart:femWomen      -0.1977312 -0.3599425 -0.0216841   203.85  0.024 *  
traitza_art:femWomen   -0.1671825 -0.3654685  0.0318293   233.12  0.090 .  
traitart:marMarried     0.0887755 -0.0960692  0.2790121   298.52  0.382    
traitza_art:marMarried  0.2426821  0.0141466  0.4792556   160.43  0.040 *  
traitart:kid5          -0.1286110 -0.2598257 -0.0066072   268.55  0.036 *  
traitza_art:kid5       -0.2140562 -0.4022002 -0.0743557   159.10  0.002 ** 
traitart:phd            0.0165779 -0.0731299  0.1028394   245.22  0.670    
traitza_art:phd         0.0302054 -0.0776700  0.1482114   152.31  0.584    
traitart:ment           0.0193229  0.0119351  0.0263783   382.92 <0.001 ***
traitza_art:ment        0.0479411  0.0331379  0.0627703    67.58 <0.001 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 
\end{Soutput}
\end{Schunk}
