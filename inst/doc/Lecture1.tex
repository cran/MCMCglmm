...
\end{Sinput}
\begin{Soutput}
[1] -0.04127626  0.90093909  0.12402192  0.97129242  0.97093060
\end{Soutput}
\end{Schunk}
...
Deviance Residuals: 
      1        2        3        4        5  
-0.6265   0.3158  -0.4612   0.3861   0.3857  

Coefficients:
            Estimate Std. Error t value Pr(>|t|)  
(Intercept)   0.5852     0.2239   2.613   0.0592 .
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 

(Dispersion parameter for gaussian family taken to be 0.2506761)

    Null deviance: 1.0027  on 4  degrees of freedom
Residual deviance: 1.0027  on 4  degrees of freedom
AIC: 10.156
...
Here we see that although the estimate of the mean (intercept) is the same, the estimate of the variance (the dispersion parameter: 0.251) is higher when fitting the model using \texttt{glm}. In fact the ML estimate is a factor of $\frac{n}{n-1}$ smaller.
...
There is Monte Carlo error in the answer (0.996) but if we collect a large number of samples then this can be minimised.\\ 
