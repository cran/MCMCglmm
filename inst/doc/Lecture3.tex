...
0.029731577 0.337123023 0.003081286 
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
                   dam fosternest       units
dam         1.00000000 -0.2212656 -0.03972778
fosternest -0.22126563  1.0000000 -0.15603099
units      -0.03972778 -0.1560310  1.00000000
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
                lower     upper
dam        0.14319866 0.3252834
fosternest 0.01766090 0.1290711
units      0.51501074 0.6389049
attr(,"Probability")
[1] 0.95
\end{Soutput}
\end{Schunk}
...
(Intercept) -0.4052 0.06685 0.002114       0.001968
sexMale      0.7714 0.05791 0.001831       0.001644
sexUNK       0.2128 0.12743 0.004030       0.003953

2. Quantiles for each variable:

                2.5%     25%     50%     75%   97.5%
(Intercept) -0.54209 -0.4480 -0.4050 -0.3607 -0.2798
sexMale      0.65537  0.7330  0.7726  0.8082  0.8905
sexUNK      -0.02915  0.1307  0.2112  0.2946  0.4641
\end{Soutput}
\end{Schunk}
...
[1,]  0.1752493   0.0000000 0.00000000
[2,]  0.0000000   0.1689354 0.00000000
[3,]  0.0000000   0.0000000 0.05723843
\end{Soutput}
\end{Schunk}

Note, that they are in general less than the marginal mean of the dam variance in model \texttt{m3a.1} (0.227)  where a sex interaction was not fitted.  Because the dam effects are assumed to be multivariate normal we can plot an ellipsoid that completely represents their distribution (you can rotate the figure in R):
...
[1,]             0.2315287              0.1993445             0.2115677
[2,]             0.1993445              0.2113756             0.2004348
[3,]             0.2115677              0.2004348             0.2557272
\end{Soutput}
\end{Schunk}
