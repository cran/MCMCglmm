...
Should we worry? Not really. We just have to be careful about how we express the results. Stating that the family variance is 0.699 is meaningless without putting it in the context of the assumed residual variance. It is therefore more appropriate to report the intraclass correlation which in this context is the expected correlation between the state Pupated/Not Pupated, for members of the same family. It can be calculated as:
...
Deviance Residuals: 
       Min          1Q      Median          3Q         Max  
-1.429e+00  -7.976e-05  -7.976e-05   9.448e-01   9.448e-01  

Coefficients:
             Estimate Std. Error z value Pr(>|z|)
(Intercept)    0.5754     0.4167   1.381    0.167
treatment2   -20.1414  2150.8026  -0.009    0.993
