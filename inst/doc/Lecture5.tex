...
-0.83680 -0.18527  0.00678  0.18541  1.02820 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)  1.05413    0.03658  28.820   <2e-16 ***
y.hol       -0.02120    0.03441  -0.616    0.538    
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 

Residual standard error: 0.2981 on 798 degrees of freedom
Multiple R-squared: 0.0004756,	Adjusted R-squared: -0.0007769 
F-statistic: 0.3797 on 1 and 798 DF,  p-value: 0.5379 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
     ...
     -0.103685       0.035671       0.001128       0.001128 

2. Quantiles for each variable:

    2.5%      25%      50%      75%    97.5% 
-0.17470 -0.12608 -0.10351 -0.08079 -0.03508 
\end{Soutput}
\end{Schunk}
...
{\color{red} \texttt{1}}&\texttt{0.684252}&\texttt{1.142830}&\texttt{1}\\
{\color{red} \texttt{2}}&\texttt{0.908457}&\texttt{0.876319}&\texttt{1}\\
\vdots&\vdots&\vdots\\
{\color{red} \texttt{800}}&\texttt{0.631011}&\texttt{1.055794}&\texttt{200}\\
\end{array}&
\Longrightarrow
\begin{array}{ccccc}
&\texttt{y}&{\color{blue} \texttt{trait}}&\texttt{id}&{\color{red} \texttt{units}}\\
1&\texttt{0.684252}&{\color{blue} \texttt{y.hol}}&\texttt{1}&{\color{red} \texttt{1}}\\
2&\texttt{0.908457}&{\color{blue} \texttt{y.hol}}&\texttt{1}&{\color{red} \texttt{2}}\\
\vdots&\vdots&\vdots&\vdots\\
800&\texttt{0.631011}&{\color{blue} \texttt{y.hol}}&\texttt{200}&{\color{red} \texttt{800}}\\
801&\texttt{1.142830}&{\color{blue} \texttt{y.car}}&\texttt{1}&{\color{red} \texttt{1}}\\
802&\texttt{0.876319}&{\color{blue} \texttt{y.car}}&\texttt{1}&{\color{red} \texttt{2}}\\
\vdots&\vdots&\vdots&\vdots\\
1600&\texttt{1.055794}&{\color{blue} \texttt{y.car}}&\texttt{200}&{\color{red} \texttt{800}}\\
\end{array}
\end{array}
\end{displaymath}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
        ...
        Mean      SD  Naive SE Time-series SE
[1,] 0.65784 0.01839 0.0005815       0.002027
[2,] 0.09608 0.01113 0.0003519       0.001560
[3,] 0.24608 0.01561 0.0004936       0.001451

2. Quantiles for each variable:

       2.5%     25%     50%    75%  97.5%
var1 0.6219 0.64478 0.65797 0.6715 0.6927
var2 0.0753 0.08779 0.09581 0.1039 0.1181
var3 0.2155 0.23588 0.24625 0.2564 0.2777
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
       ...
       Mean      SD  Naive SE Time-series SE
[1,] 0.3447 0.03021 0.0009553       0.002772
[2,] 0.2585 0.02859 0.0009042       0.002782
[3,] 0.3968 0.03263 0.0010319       0.005302

2. Quantiles for each variable:

       2.5%    25%    50%    75%  97.5%
var1 0.2846 0.3246 0.3443 0.3633 0.4062
var2 0.2045 0.2386 0.2587 0.2781 0.3150
var3 0.3353 0.3723 0.3968 0.4188 0.4601
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
         ...
         Mean       SD  Naive SE Time-series SE
[1,] 0.826675 0.018394 5.817e-04       0.002120
[2,] 0.008283 0.002537 8.023e-05       0.000600
[3,] 0.165041 0.018220 5.762e-04       0.002192

2. Quantiles for each variable:

         2.5%      25%      50%     75%   97.5%
var1 0.790991 0.814284 0.826451 0.83956 0.86178
var2 0.004876 0.006501 0.007724 0.00941 0.01437
var3 0.131902 0.152288 0.164835 0.17719 0.20216
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
         0%         25%         50%         75%        100% 
0.001102686 0.002420975 0.009130688 0.019861700 0.038223419 
\end{Soutput}
\end{Schunk}
...
trait:units    0.3506   0.2571   0.4595    48.66

 Location effects: art ~ trait * (fem + mar + kid5 + phd + ment) 

                       post.mean  l-95% CI  u-95% CI
(Intercept)             0.372063  0.066477  0.717250
traitza_art            -0.551020 -1.095388 -0.033799
femWomen               -0.202201 -0.369652 -0.025869
marMarried              0.084918 -0.089353  0.271431
kid5                   -0.130990 -0.249506 -0.007220
phd                     0.008565 -0.070491  0.091885
ment                    0.019333  0.011452  0.025455
traitza_art:femWomen    0.039063 -0.237097  0.312060
traitza_art:marMarried  0.142220 -0.175389  0.464209
traitza_art:kid5       -0.080029 -0.295746  0.108169
traitza_art:phd         0.013762 -0.117306  0.148531
traitza_art:ment        0.027737  0.011624  0.045142
                       eff.samp  pMCMC    
(Intercept)               247.2  0.036 *  
traitza_art               182.4  0.030 *  
femWomen                  370.9  0.014 *  
marMarried                281.6  0.350    
kid5                      225.4  0.032 *  
phd                       287.4  0.850    
ment                      761.6 <0.001 ***
traitza_art:femWomen      189.8  0.786    
traitza_art:marMarried    176.2  0.398    
traitza_art:kid5          204.8  0.438    
traitza_art:phd           189.0  0.838    
traitza_art:ment          105.7 <0.001 ***
---
Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1 
\end{Soutput}
\end{Schunk}
