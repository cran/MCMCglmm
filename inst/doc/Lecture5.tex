...
A simple regression suggests the two types of spending are negatively related but the association is weak with the $R^{2}=$ 0.004.
...
-0.973730 -0.180634  0.002579  0.163683  1.172051 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)    
(Intercept)  1.05925    0.03374  31.390   <2e-16 ***
y.hol       -0.05613    0.03202  -1.753     0.08 .  
---
Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1 

Residual standard error: 0.2776 on 798 degrees of freedom
Multiple R-squared: 0.003836,	Adjusted R-squared: 0.002588 
F-statistic: 3.073 on 1 and 798 DF,  p-value: 0.07999 
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
    ...
    -0.1582607      0.0330955      0.0010466      0.0009278 

2. Quantiles for each variable:

   2.5%     25%     50%     75%   97.5% 
-0.2228 -0.1798 -0.1586 -0.1356 -0.0949 
\end{Soutput}
\end{Schunk}
...
{\color{red} \texttt{1}}&\texttt{1.131162}&\texttt{0.725513}&\texttt{1}\\
{\color{red} \texttt{2}}&\texttt{0.846146}&\texttt{1.491301}&\texttt{1}\\
\vdots&\vdots&\vdots\\
{\color{red} \texttt{800}}&\texttt{0.639202}&\texttt{1.236248}&\texttt{200}\\
\end{array}&
\Longrightarrow
\begin{array}{ccccc}
&\texttt{y}&{\color{blue} \texttt{trait}}&\texttt{id}&{\color{red} \texttt{units}}\\
1&\texttt{1.131162}&{\color{blue} \texttt{y.hol}}&\texttt{1}&{\color{red} \texttt{1}}\\
2&\texttt{0.846146}&{\color{blue} \texttt{y.hol}}&\texttt{1}&{\color{red} \texttt{2}}\\
\vdots&\vdots&\vdots&\vdots\\
800&\texttt{0.639202}&{\color{blue} \texttt{y.hol}}&\texttt{200}&{\color{red} \texttt{800}}\\
801&\texttt{0.725513}&{\color{blue} \texttt{y.car}}&\texttt{1}&{\color{red} \texttt{1}}\\
802&\texttt{1.491301}&{\color{blue} \texttt{y.car}}&\texttt{1}&{\color{red} \texttt{2}}\\
\vdots&\vdots&\vdots&\vdots\\
1600&\texttt{1.236248}&{\color{blue} \texttt{y.car}}&\texttt{200}&{\color{red} \texttt{800}}\\
\end{array}
\end{array}
\end{displaymath}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
       ...
       Mean      SD  Naive SE Time-series SE
[1,] 0.6519 0.01866 0.0005899       0.001998
[2,] 0.1015 0.01082 0.0003420       0.001376
[3,] 0.2465 0.01608 0.0005086       0.001668

2. Quantiles for each variable:

        2.5%     25%    50%    75%  97.5%
var1 0.61832 0.63892 0.6505 0.6646 0.6908
var2 0.08042 0.09419 0.1010 0.1083 0.1252
var3 0.21373 0.23583 0.2465 0.2569 0.2782
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
       ...
       Mean      SD  Naive SE Time-series SE
[1,] 0.3425 0.02890 0.0009139       0.002738
[2,] 0.2652 0.02801 0.0008856       0.002709
[3,] 0.3923 0.02690 0.0008508       0.002845

2. Quantiles for each variable:

       2.5%    25%    50%    75%  97.5%
var1 0.2910 0.3229 0.3412 0.3607 0.4059
var2 0.2119 0.2455 0.2634 0.2847 0.3183
var3 0.3428 0.3746 0.3920 0.4100 0.4458
\end{Soutput}
\end{Schunk}
...
1. Empirical mean and standard deviation for each variable,
   plus standard error of the mean:
         ...
         Mean      SD  Naive SE Time-series SE
[1,] 0.830519 0.01638 5.181e-04      0.0018133
[2,] 0.007157 0.00285 9.013e-05      0.0004108
[3,] 0.162324 0.01575 4.981e-04      0.0017257

2. Quantiles for each variable:

         2.5%      25%      50%      75%   97.5%
var1 0.795932 0.819874 0.831229 0.842285 0.86029
var2 0.003288 0.004602 0.006822 0.009094 0.01315
var3 0.134319 0.150683 0.161060 0.172850 0.19640
\end{Soutput}
\end{Schunk}
...
\begin{Schunk}
\begin{Sinput}
> quantile(inv.logit(m5d.1$Sol[, 2]/sqrt(1 + c2)))
\end{Sinput}
\begin{Soutput}
         0%         25%         50%         75%        100% 
0.001105795 0.002941390 0.007548893 0.012695060 0.058058227 
\end{Soutput}
\end{Schunk}
...
+     prior = prior, family = "poisson", saveX = TRUE, verbose = FALSE)
> nz <- 1:1000
