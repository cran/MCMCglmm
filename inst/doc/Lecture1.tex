...
\end{Sinput}
\begin{Soutput}
[1] -0.0689500 -1.2876027  0.6259583 -0.2387196 -0.2120337
\end{Soutput}
\end{Schunk}
...
Deviance Residuals: 
       1         2         3         4         5  
 0.16732  -1.05133   0.86223  -0.00245   0.02424  

Coefficients:
            Estimate Std. Error t value Pr(>|t|)
(Intercept)  -0.2363     0.3064  -0.771    0.484

(Dispersion parameter for gaussian family taken to be 0.4693319)

    Null deviance: 1.8773  on 4  degrees of freedom
Residual deviance: 1.8773  on 4  degrees of freedom
AIC: 13.291
...
Here we see that although the estimate of the mean (intercept) is the same, the estimate of the variance (the dispersion parameter: 0.469) is higher when fitting the model using \texttt{glm}. In fact the ML estimate is a factor of $\frac{n}{n-1}$ smaller.
...
There is Monte Carlo error in the answer (0.981) but if we collect a large number of samples then this can be minimised.\\ 
