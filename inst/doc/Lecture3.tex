...
-0.005412770  0.347055040  0.008737537 
\end{Soutput}
\begin{Sinput}
> plot(m3a.1$VCV)
\end{Sinput}
...
\begin{Soutput}
                   dam fosternest       units
dam         1.00000000 -0.2196589 -0.02165193
fosternest -0.21965893  1.0000000 -0.14094742
units      -0.02165193 -0.1409474  1.00000000
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
                 lower     upper
dam        0.133582613 0.3292076
fosternest 0.008375365 0.1222961
units      0.514814500 0.6370544
attr(,"Probability")
[1] 0.95
\end{Soutput}
\end{Schunk}
...
dam    0.2267   0.1336   0.3292    840.8

               ~fosternest

           post.mean l-95% CI u-95% CI eff.samp
fosternest   0.06692 0.008375   0.1223    484.2

 R-structure:  ~units

      post.mean l-95% CI u-95% CI eff.samp
units    0.5725   0.5148    0.637     1000

 Location effects: tarsus ~ sex 

            post.mean l-95% CI u-95% CI eff.samp  pMCMC    
(Intercept)   -0.4044  -0.5363  -0.2770     1000 <0.001 ***
sexMale        0.7702   0.6610   0.8805     1000 <0.001 ***
sexUNK         0.2054  -0.0422   0.4389     1328  0.086 .  
---
...
[1,] 0.173433 0.0000000 0.00000000
[2,] 0.000000 0.1692554 0.00000000
[3,] 0.000000 0.0000000 0.04257395
\end{Soutput}
\end{Schunk}
...
[1,]   0.2297563    0.2002515   0.2050976
[2,]   0.2002515    0.2117400   0.1961479
[3,]   0.2050976    0.1961479   0.2510483
\end{Soutput}
\end{Schunk}
