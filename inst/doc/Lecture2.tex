...
\end{Sinput}
\begin{Soutput}
[1] 3.006432 3.008972 3.011512 3.014052 3.016592
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
[1] 22.18010 22.23481 22.28969 22.34476 22.40000
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
       fit      lwr      upr
1 22.18010 19.17429 25.31483
2 22.23481 19.04716 25.11008
3 22.28969 19.14483 25.12002
4 22.34476 19.24300 25.14558
5 22.40000 19.44682 25.28616
\end{Soutput}
\end{Schunk}
...
\begin{Soutput}
       fit      lwr      upr
1 22.09751 7.762836 42.19853
2 22.77109 6.468017 42.59632
3 21.94235 7.054751 39.60715
4 22.51910 6.761624 43.10373
5 22.38702 6.511929 41.56868
\end{Soutput}
\end{Schunk}
...
Should we worry? Not really. We just have to be careful about how we express the results. Stating that the family variance is 0.766 is meaningless without putting it in the context of the assumed residual variance. It is therefore more appropriate to report the intraclass correlation which in this context is the expected correlation between the state Pupated/Not Pupated, for members of the same family. It can be calculated as:
...
Deviance Residuals: 
       Min          1Q      Median          3Q         Max  
-1.281e+00  -7.976e-05  -7.976e-05   1.077e+00   1.077e+00  
...
\begin{Soutput}
        fit         lwr         upr 
0.043341536 0.002217133 0.104788821 
\end{Soutput}
\end{Schunk}
